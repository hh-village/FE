  ...
  return (
    <Div width="100%" marginTop="5rem">
        ...
        <Div fDirection="row" width="100%" height="500px" jc="space-between" gap="1.5rem">
            <Div width="100%" height="100%" bgColor="#8b78ff" onClick={()=>window.location.href="https://docs.google.com/forms/d/1buMv3vjJuCTB40_tYxWescJU4ijJesZVfEPwuGz1Tzs/viewform?edit_requested=true"}>
